...
import 'package:products_management/features/createProduct/pages/create_update_product.dart';
                          ...
                          rows: List<DataRow>.generate(
                            ...
                            (index) => DataRow(
                              cells: [
                                ...
                                DataCell(
                                  CustomText(
                                    text: reversed[index].nbrePiece.toString(),
                                  ),
                                ),
                                DataCell(
                                  CustomText(
                                ...
                                DataCell(
                                  CustomText(
                                    text: reversed[index].prixOrTax.toString(),
                                  ),
                                ),
                                DataCell(
                                  CustomText(
